...
Original file is located at
    https://colab.research.google.com/drive/1Ax4wmaIfk6gSGzQ9NqOQ2zT3GzS666gX
"""
...
def get_model():
    return AutoModelForSequenceClassification.from_pretrained("cardiffnlp/twitter-xlm-roberta-base-sentiment")
...
checkpoint_path = "./checkpoints_epochs/model_seed_66_epoch_5.pth"  # Chemin du modèle
# Use AutoModelForSequenceClassification instead of BertForSequenceClassification
model = AutoModelForSequenceClassification.from_pretrained("cardiffnlp/twitter-xlm-roberta-base-sentiment")
