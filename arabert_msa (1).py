...
Original file is located at
    https://colab.research.google.com/drive/1nMAWmQp-npl3YAJAlcrd_dRWvhUja1rq
"""
...
checkpoint_path = "./checkpoints_epochs/model_seed_66_epoch_6.pth"  # Chemin du modèle
model = BertForSequenceClassification.from_pretrained("Ammar-alhaj-ali/arabic-MARBERT-sentiment")   # Charger l'architecture avec le nom du modèle pré-entraîné
...
checkpoint_path = "./checkpoints_epochs/model_seed_66_epoch_7_catt.pth"  # Chemin du modèle
model = BertForSequenceClassification.from_pretrained("Ammar-alhaj-ali/arabic-MARBERT-sentiment")   # Charger l'architecture avec le nom du modèle pré-entraîné
model.load_state_dict(torch.load(checkpoint_path))  # Charger les poids entraînés
model.eval()  # Mode évaluation
