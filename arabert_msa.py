...
Original file is located at
    https://colab.research.google.com/drive/10NCmLgmOP1slVJA90HmyoBmOtzeN-fAD
"""
...
training_path = "train_final_tashkeel.csv"
testing_path = "test_final_tashkeel.csv"
validation_path = "validation_final_tashkeel.csv"
...
def get_model():
    return AutoModelForSequenceClassification.from_pretrained("PRAli22/AraBert-Arabic-Sentiment-Analysis")
...
checkpoint_path = "./checkpoints_epochs/model_seed_66_epoch_3.pth"  # Chemin du modèle
model = BertForSequenceClassification.from_pretrained("PRAli22/AraBert-Arabic-Sentiment-Analysis")  # Charger l'architecture avec le nom du modèle pré-entraîné
...
checkpoint_path = "./checkpoints_epochs/model_seed_66_epoch_3_catt.pth"  # Chemin du modèle
model = BertForSequenceClassification.from_pretrained("PRAli22/AraBert-Arabic-Sentiment-Analysis")  # Charger l'architecture avec le nom du modèle pré-entraîné
model.load_state_dict(torch.load(checkpoint_path))  # Charger les poids entraînés
model.eval()  # Mode évaluation
