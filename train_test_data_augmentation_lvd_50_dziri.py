# -*- coding: utf-8 -*-
"""Train_test_data_augmentation_LVD_50_dziri.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1wOY__XKL9C99QU9DjaUpdiDJCWNVLjBm
"""
...
training_path = "/content/df_train_LVD_DZ50p.tsv"
testing_path = "/content/test_final_tashkeel.csv"
validation_path = "/content/validation_final_tashkeel.csv"
...
print("Columns in df_train after loading cleaned file:", df_train.columns)
...
# Charger le modèle fine-tuné
checkpoint_path = "./checkpoints_epochs/model_seed_66_epoch_2_catt.pth"  # Chemin du modèle
# Use the correct model architecture: AutoModelForSequenceClassification
# and the same pre-trained model used for training
model = BertForSequenceClassification.from_pretrained("alger-ia/dziribert_sentiment")
model.load_state_dict(torch.load(checkpoint_path))  # Charger les poids entraînés
