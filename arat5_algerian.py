# -*- coding: utf-8 -*-
"""AraT5_Algerian.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1GR0wd2zHyRVZtzLughYoBk2xZS6RX_vP
"""
...
model_name = "Noanihio/arat5v2-darja-sentiment"
model = AutoModelForSeq2SeqLM.from_pretrained(model_name).to("cuda")
tokenizer = AutoTokenizer.from_pretrained(model_name)

# ✅ Chargement du dataset de test
df_test = pd.read_csv("/content/df_test_with_catt_DZ1.tsv", sep="\t")
