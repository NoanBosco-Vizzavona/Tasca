# -*- coding: utf-8 -*-
"""AraBert_Algerian.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1eIYHDZsZ7v-lx-l-dA3VLnWBlibudM6U
"""
...
training_path = "/content/df_train_with_catt.tsv"
validation_path = "/content/df_val_with_catt.tsv"
testing_path = "/content/df_test_with_catt.tsv"
...
checkpoint_path = "./checkpoints_epochs/model_seed_66_epoch_5_catt.pth"  # Chemin du modèle
model = BertForSequenceClassification.from_pretrained("PRAli22/AraBert-Arabic-Sentiment-Analysis")  # Charger l'architecture avec le nom du modèle pré-entraîné
model.load_state_dict(torch.load(checkpoint_path))  # Charger les poids entraînés
model.eval()  # Mode évaluation
