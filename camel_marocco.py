...
Original file is located at
    https://colab.research.google.com/drive/1gfaRBFaF7poGNHYL91T1GY5KlliH_OFB
"""
...
training_path = "/content/train_final_tashkeel_MAR2.csv"
validation_path = "/content/validation_final_tashkeel_MAR2.csv"
testing_path = "/content/test_final_tashkeel_MAR2.csv"
...
model = BertForSequenceClassification.from_pretrained("CAMeL-Lab/bert-base-arabic-camelbert-mix-sentiment")  # Charger l'architecture avec le nom du modèle pré-entraîné
...
# 🔸 Use the same model architecture as when you saved the checkpoint
model = BertForSequenceClassification.from_pretrained("CAMeL-Lab/bert-base-arabic-camelbert-mix-sentiment") # Charger l'architecture avec le nom du modèle pré-entraîné
model.load_state_dict(torch.load(checkpoint_path))  # Charger les poids entraînés
model.eval()  # Mode évaluation
